...
const getProfileById= async () => {
    const response = await axios.get('https://fastfood-api-bz41.onrender.com/edit-profile/6504aa313ab5ff3e0fc809ab');
...
const updateProfile = async (e) => {
    ...
    try {
        await axios.patch('https://fastfood-api-bz41.onrender.com/editprofile/6504aa313ab5ff3e0fc809ab', {
